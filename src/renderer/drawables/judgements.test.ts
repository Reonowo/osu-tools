  ...
  function sceneWithOneGreatHit() {
    return testScene({
      simulation: {
        ...
        events: [{ time: 1000, objectIndex: 0, kind: { type: "circle", grade: "great" }, comboAfter: 1, accuracyAfter: 1 }],
  ...
  test("the same scenario holds for the tickMiss popup shape", () => {
    const scene = testScene({
      renderPlan: {
        ...
        objects: [{
          startTime: 1000, endTime: 1500, position: [100, 100], stackHeight: 0,
          comboColourIndex: 1, comboIndex: 1, indexInCombo: 0,
          preempt: 600, fadeIn: 400,
          kind: {
            type: "slider", vertices: [100, 100, 200, 100], cumulativeLengths: [0, 100], distance: 100,
            segmentEnds: [1], repeatCount: 0, spanCount: 1, spanDuration: 500, duration: 500,
            endPosition: [200, 100], snakeInDuration: 200,
            nested: [{ kind: "tick", spanIndex: 0, time: 1000, position: [100, 100], pathProgress: 0, preempt: 600, fadeIn: 400 }],
          },
        }],
      },
      simulation: {
        status: "authoritative",
        events: [{ time: 1000, objectIndex: 0, kind: { type: "sliderTick", hit: false }, comboAfter: 0, accuracyAfter: 1 }],
