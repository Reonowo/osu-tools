...
function circle(startTime: number, x: number, y: number, comboIndex: number): RenderObject {
  return {
    startTime, endTime: startTime, position: [x, y], stackHeight: 0,
    comboColourIndex: comboIndex, comboIndex, indexInCombo: 0,
  ...
  test("sliders connect from their stacked end position", () => {
    const slider: RenderObject = {
      ...
      kind: {
        ...
        endPosition: [100, 0], snakeInDuration: 200, nested: [],
      },
    };
