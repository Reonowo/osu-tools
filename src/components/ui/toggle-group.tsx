...
function ToggleGroup({
	...
	return (
		<ToggleGroupPrimitive
			...
			// the primitive destructures its own `orientation` prop for composite
			// keyboard nav (CompositeRoot) and does not infer it back from
			// data-orientation -- without this, arrow-key navigation would stay
			// horizontal even once the css above lays items out vertically
			orientation={orientation}
			style={{ "--gap": spacing } as React.CSSProperties}
			className={cn(
				// base ui reports orientation as data-orientation="horizontal"|"vertical"
